...
- inventory-service (5002) where x is the first digit of my employee number
- shipping-service (5009) where x is the second digit of my employee number
- users-service (5001) where x is the third digit of my employee number
- billing-service (5007) where x is the fourth digit of my employee number
